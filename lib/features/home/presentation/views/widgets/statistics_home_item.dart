...
class StatisticsHomeItem extends StatelessWidget {
  const StatisticsHomeItem({super.key, required this.icon, required this.title, required this.value, this.onTap, this.size});
  final String icon;
  final String title;
  final String value;
  final double? size;
    ...
    return Expanded(
      child: InkWell(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              SvgPicture.asset(icon,width: size??MediaQuery.of(context).size.width*.1,),
